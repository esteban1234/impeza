...
<p class="subtit">Servicios para centros de trabajo</p>
	</article>
...
<article class="caja_q">
			...
			<article class="caja_q_1">
                ...
                <article class="contentexto_caja">
                    ...
                    <span><i class="fa fa-check" aria-hidden="true"></i></span>&nbsp;Personal de limpieza para empresas.<br><br>
            ...
            <article class="caja_q_1">
                ...
                <article class="contentexto_caja">
                    ...
                    <span><i class="fa fa-check" aria-hidden="true"></i></span>&nbsp;Comercialización e instalación de sistemas de alarma y seguridad.</p>
                </article>
            </article>
